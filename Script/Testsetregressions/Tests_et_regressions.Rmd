...
```{r cor-exe, fig.height=7, exercise=T, exercise.eval=T}
head(mtcars)
...
```{r chi2, exercise = T, exercise.eval = F}
...
```{r crab_p, exercise = T, exercise.eval = T, exercise.lines = 9}
head(crabs)
```
...
```{r air_np, exercise = T, exercise.eval = T, exercise.lines = 9}
head(airquality2)
```
...
```{r anxie_pair, exercise = T, exercise.eval = T, exercise.lines = 9}
head(anxiety)
```
...
```{r air_groups_np, exercise = T, exercise.eval = F, exercise.lines = 9}
...
```{r yields_groups_p, exercise = T, exercise.eval = T, exercise.lines = 9}
head(PlantGrowth)
```
...
```{r tooth_inter, exercise = T, exercise.eval = T, exercise.lines = 9}
head(ToothGrowth)
```
...
```{r crab_lm, exercise = T, exercise.eval = T, exercise.lines = 9}
head(crabs)
```
...
```{r crab_ancova, exercise = T, exercise.eval = T, exercise.lines = 9}
head(crabs)
```
...
```{r truite_glm, exercise = T, exercise.eval = T, exercise.lines = 9}
...
```{r truite_step, exercise = T, exercise.eval = T, exercise.lines = 9}
truite <- ifelse(doubs$fish$Satr > 0, 1 ,0)
...
```{r ozone-gam, exercise = T, exercise.eval = T, exercise.lines = 9}
...
```{r gam-plot, exercise = T, exercise.eval = F, exercise.lines = 9}
