...
## ----five-plus-seven, echo=TRUE, exercise=F------------------------------
5 + 7
...
#' 
## ----calcul-limit, exercise=TRUE, exercise.eval=TRUE---------------------
...
## ----assign-tools, exercise=T--------------------------------------------


#' 
#' ➤ 2 questions pour voir si vous avez suivi :
## ----qcm-assign-a, echo=FALSE--------------------------------------------
quiz(
...
## ----pyramide-class, exercise=TRUE, exercise.eval=TRUE-------------------
...
## ----vecteur, exercise=TRUE, exercise.eval=TRUE--------------------------
...
#' 
## ----select-vecteur, exercise=TRUE---------------------------------------


#' 
## ----select-vecteur-hint-1-----------------------------------------------
...
#' 
## ----matrix-m, exercise=TRUE, exercise.eval=TRUE-------------------------
k <- c(0, 1, 3, 4)
l <- c(2, 5, 0, 1)
...
## ----dimension-matrix, exercise=TRUE, exercise.eval=TRUE-----------------
...
#' 
## ----selection-matrix, exercise=TRUE-------------------------------------


#' 
## ----qcm-matrix, echo=FALSE----------------------------------------------
quiz(
...
#' 
#' 
## ----matrix-function, exercise=TRUE, exercise.eval=TRUE------------------
...
#' 
## ----df-creation, exercise=TRUE, exercise.eval=TRUE, exercise.lines = 6----
...
## ----df-colonne-essai, exercise=TRUE-------------------------------------
...
#' 
## ----df, exercise=TRUE, exercise.eval=FALSE, exercise.lines = 10---------
...
#' 
## ----par-plot, exercise = T, exercise.eval=T-----------------------------
...
#' 
## ----boxplt, echo=TRUE, exercise = T, exercise.eval=T--------------------
...
#' 
## ----histplt, echo=TRUE, exercise = T, exercise.eval=T-------------------
...
#' 
## ----barplt, echo=TRUE, exercise = T, exercise.eval=T--------------------
...
#' - pie chart `pie()` :
#' 
## ----pieplt, exercise=TRUE, exercise.eval=T------------------------------
...
#' 
## ----pairplt, echo=TRUE, exercise = T, exercise.eval=T-------------------
...
#' 
## ----legenplt, echo=TRUE, fig.height=7, exercise = T, exercise.eval=T----
#Le graphique
