...
#' 
#' Si on compare les deux scripts, la majeure différence est que les arguments de `plot` deviennent des fonctions dans `ggplot`. Ensuite GGplot ne devine pas le meilleur graphe possible avec les variables renseignées, ce qui permet une plus grande flexibilité dans les sorties.
#' 
