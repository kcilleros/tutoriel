...
#' 
## ----acp, exercise=TRUE, exercise.eval=TRUE, exercise.lines = 12---------
head(mafragh$env)
...
#' 
## ----afc, exercise=TRUE, exercise.eval=TRUE, exercise.lines = 12---------
caith
...
#' 
## ----acm, fig.height=8, fig.width=8, message=FALSE, warning=FALSE, exercise=TRUE, exercise.eval=TRUE, exercise.lines=12----
for(i in c(1:8,10)){
...
#' 
## ----coin, exercise=TRUE, exercise.eval=TRUE, exercise.lines = 12--------
...
#' 
## ----rtree, exercise=TRUE, exercise.eval=TRUE, exercise.lines = 12-------
head(iris)
...
#' 
## ----kmeans, exercise=TRUE, exercise.eval=TRUE, exercise.lines = 12------
...
#' 
## ----clust1, message=FALSE, warning=FALSE, exercise=TRUE, exercise.eval=TRUE, exercise.lines=12----
...
#' 
## ----clust2, message=FALSE, warning=FALSE, exercise=TRUE, exercise.eval=TRUE, exercise.lines=12----
...
#' 
## ----clust3, message=FALSE, warning=FALSE, exercise=TRUE, exercise.eval=TRUE, exercise.lines=12----
...
#' 
## ----afd, fig.height=8, fig.width=8, message=FALSE, warning=FALSE, exercise=TRUE, exercise.eval=TRUE, exercise.lines=12----
...
#' 
## ----ccacoln, fig.height=8, fig.width=8, message=FALSE, warning=FALSE, exercise=TRUE, exercise.eval=TRUE, exercise.lines=12----
